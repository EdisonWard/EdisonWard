...
-	Performed monthly patches of servers through SCCM and OS updates enhancing security and performance. 
-	Tested, deployed, and maintained OneDrive in the environment safeguarding data to the cloud ensuring no loss of work in case system access becomes inaccessible. 
...
-	Executed multiple live streaming events concurrently; being the sole owner of many tier 1 live events ensure the highest customer quality experience.
-	Worked on operations driving improvements and automation.
